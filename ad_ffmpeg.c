...
kprintf ("B0 %s:%d   sh_audio->sample_format = 0x%08x sample_format = 0x%08x fmt = 0x%08x\n", 
          __FILE__, __LINE__, sh_audio->sample_format, sample_format, lavc_context->sample_fmt);               
...
kprintf ("B1 %s:%d   sh_audio->sample_format = 0x%08x sample_format = 0x%08x \n", 
          __FILE__, __LINE__, sh_audio->sample_format, sample_format);          
    if(sh_audio->wf){
...
kprintf ("B2 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);              
...
kprintf ("B3 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);                      
        return 1;
    }
kprintf ("B3 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);                  
    return 0;
...
kprintf ("111 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
    init_avcodec();
kprintf ("2 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
    lavc_codec = avcodec_find_decoder_by_name(sh_audio->codec->dll);
kprintf ("3 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);         
    if(!lavc_codec){
...
kprintf ("4 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
    // for QDM2
...
kprintf ("5 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
    /* open it */
...
kprintf ("6 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
//   printf("\nFOURCC: 0x%X\n",sh_audio->format);
...
kprintf ("7 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
...
kprintf ("8 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);   
  return 1;
}
...
static int decode_audio(sh_audio_t *sh_audio,unsigned char *buf,int minlen,int maxlen)
{
	...
	kprintf ("A1 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);     
	y=avcodec_decode_audio3(sh_audio->context,(int16_t*)buf,&len2,&pkt);
	kprintf ("A2 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);  
...
kprintf ("A3 %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);  
        if (setup_format(sh_audio, sh_audio->context))
            break;
    }
kprintf ("A4  %s:%d   sh_audio->sample_format = 0x%08x \n", __FILE__, __LINE__, sh_audio->sample_format);      
  return len;
}
